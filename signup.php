...
<?php
		...
		if($_SERVER['REQUEST_METHOD'] == "POST")
		{
		    ...
		    //$id = $_SESSION['user_id'];
			$query = "INSERT INTO tbl_user (first_name, last_name, username,phone_no, email, password) VALUES('$first_name', '$last_name', '$username', '$phone', '$email', '$pass');";
...
<title>TOTO Sign Up Form Responsive Widget Template| Home :: Khulna</title>
<!-- Meta tag Keywords -->
...
<!--footer-->
<div class="footer-w3">
	<p>&copy; TOTO Sign Up Form . All rights reserved | Design by @MD.Mushfiqur Rahman Rifat</a></p>
</div>
<!--//footer-->
