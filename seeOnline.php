...
<body>
   ...
   <?php include 'navi.php'?>
        ...
        <div id="page-wrapper" >
                  ...
                  if($_SERVER['REQUEST_METHOD'] == "POST")
                  {
                    ...
                    while($result2 = $result1->fetch_assoc()){
                      ...
                      if($result2['product_name']===$user){
                        $id = $result2['quantity'];
                        $sql = "DELETE from tbl_online where quantity = '$id'";
                        $sql1 = $db->delete($sql);
                        if($sql1)                        
            ...
            <?php
              $query = "select * from tbl_online order by order_time asc";
              $notice = $db->select($query);
              while($result = $notice->fetch_assoc()){
              ?>
              
              <h3><a href="#"><?php echo  $result['customer_name']; ?></a></h3>
              ...
              <p><?php echo $result['order_time']; ?></p>
