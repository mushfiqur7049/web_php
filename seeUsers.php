   ...
   <?php include 'navi.php'?>
        ...
        <div id="page-wrapper" >
            ...
            <?php
              ...
              ?>
              <div class="sh">
              <img src="uploads/<?php echo $result['image']; ?>" alt="<?php echo $_SESSION['username']; ?>" style="height: 100%;width:100%"> <br><?php $txt=$x.". ".$result['first_name']." ".$result['last_name']."<br>Email: ".$result['email']."<br>Phone_No: ".$result['phone_no']."<br>"; ?> 
